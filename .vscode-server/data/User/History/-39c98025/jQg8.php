...
<head>
    ...
    <!-- <script type="text/javascript" src="{{ URL::asset('resources/js/switch.js') }}"></script> -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <!-- <li class="nav-item form-check form-switch ms-auto mt-2">
                        <label class="form-check-label ms-3" for="lightSwitch">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="25"
                        ...
                        <div class="nav-item form-check form-switch ms-auto mt-2 dropdown color-modes">
