...
@section('content')
<div class="container">
    <form class="mt-2" name="create_platform" action="{{route('posts.update',$post)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-group mb-3">
        ...
        <textarea type="text" class="form-control" id="user_id" name="user_id">
        </textarea>
    </div>
